...
public class HunterEntityRegistry {
	...
	public static final RegistryObject<EntityType<Hunter>> HUNTERILLAGER = ENTITIES_REGISTRY.register("hunterillager", () -> EntityType.Builder.of(Hunter::new, MobCategory.MONSTER).sized(0.6F, 1.95F).clientTrackingRange(8).build(prefix("hunterillager")));
