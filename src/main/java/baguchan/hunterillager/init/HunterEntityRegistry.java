...
public class HunterEntityRegistry {
	...
	public static final EntityType<BoomerangEntity> BOOMERANG = EntityType.Builder.<BoomerangEntity>of(BoomerangEntity::new, EntityClassification.MISC).setCustomClientFactory(BoomerangEntity::new).sized(0.4F, 0.2F).build(prefix("boomerang"));
