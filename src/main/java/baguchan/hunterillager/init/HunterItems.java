...
public class HunterItems {
	...
	public static final RegistryObject<Item> SPAWNEGG_HUNTERILLAGER = ITEM_REGISTRY.register("spawnegg_hunterillager", () -> new ForgeSpawnEggItem(HunterEntityRegistry.HUNTERILLAGER, 9804699, 5777447, (new Item.Properties())));
