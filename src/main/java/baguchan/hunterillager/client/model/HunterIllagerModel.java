...
public class HunterIllagerModel<T extends HunterIllagerEntity> extends IllagerModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		partdefinition4.addOrReplaceChild("quiver", CubeListBuilder.create().texOffs(20, 64).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 13.0F, 3.0F, new CubeDeformation(-0.5F)).texOffs(36, 64).addBox(-2.5F, 0.0F, -2.5F, 5.0F, 13.0F, 3.0F), PartPose.offset(3.0F, 0.0F, 2.5F));
		partdefinition5.addOrReplaceChild("cape_lower", CubeListBuilder.create().texOffs(0, 76).addBox(-4.5F, 0.0F, -0.5F, 9.0F, 8.0F, 1.0F).texOffs(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 18.0F, 6.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, 11.0F, 0.0F));
