...
public class HunterVariant {
    public static final Codec<HunterVariant> DIRECT_CODEC = RecordCodecBuilder.create(
            instance -> instance.group(
                            ...
                            RegistryCodecs.holderSet(Registries.BIOME).fieldOf("biomes").forGetter(HunterVariant::biomes)
                    )
                    .apply(instance, HunterVariant::new)
    );
    public static final Codec<Holder<HunterVariant>> CODEC = RegistryFileCodec.create(HunterVariants.HUNTER_VARIANT_KEY, DIRECT_CODEC, false);
