...
public class HunterVariants {
    public static final ResourceKey<Registry<HunterVariant>> HUNTER_VARIANT_KEY = ResourceKey.createRegistryKey(Identifier.fromNamespaceAndPath(HuntersReturn.MODID, "hunter_variant"));
    ...
    private static ResourceKey<HunterVariant> createKey(String name) {
        return ResourceKey.create(HUNTER_VARIANT_KEY, Identifier.fromNamespaceAndPath(HuntersReturn.MODID, name));
    }
    ...
    static void register(BootstrapContext<HunterVariant> context, ResourceKey<HunterVariant> key, String name, HolderSet<Biome> biomeHolderSet) {
        Identifier resourcelocation = HuntersReturn.locate("entity/hunter/" + name);
        Identifier resourcelocation2 = HuntersReturn.locate("entity/hunter/" + name + "_old");
