...
public class HunterItems {
    ...
    public static final DeferredItem<SpawnEggItem> SPAWNEGG_HUNTER = ITEM_REGISTRY.register("hunter_spawn_egg", () -> new SpawnEggItem(HunterEntityRegistry.HUNTERILLAGER.get(), (new Item.Properties().setId(prefix("hunter_spawn_egg")))));
