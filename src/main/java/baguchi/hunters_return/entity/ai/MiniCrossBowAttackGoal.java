...
public class MiniCrossBowAttackGoal<T extends net.minecraft.world.entity.Mob & CrossbowAttackMob> extends Goal {
    ...
    private final T mob;
    private MiniCrossBowAttackGoal.CrossbowState crossbowState = MiniCrossBowAttackGoal.CrossbowState.UNCHARGED;
    ...
    public void tick() {
        ...
        if (livingentity != null) {
            ...
            if (this.crossbowState == MiniCrossBowAttackGoal.CrossbowState.UNCHARGED) {
                if (!flag2) {
                    this.mob.startUsingItem(ProjectileUtil.getWeaponHoldingHand(this.mob, item -> item instanceof CrossbowItem));
                    this.crossbowState = MiniCrossBowAttackGoal.CrossbowState.CHARGING;
                    this.mob.setChargingCrossbow(true);
                }
            } else if (this.crossbowState == MiniCrossBowAttackGoal.CrossbowState.CHARGING) {
                if (!this.mob.isUsingItem()) {
    ...
    private boolean canRun() {
        return this.crossbowState == MiniCrossBowAttackGoal.CrossbowState.UNCHARGED;
    }
